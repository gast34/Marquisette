...
if(document.cookie.indexOf("disclaimerok")<=-1)
{
 ...
 +"#disclaimer-cadre{ width:718px; padding:10px; margin:150px auto 0 auto; text-align:left; background:#fff0ce; border:#312f48 2px solid; -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; }"
